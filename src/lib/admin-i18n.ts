...
const dict = {
  ...
  "settings.navigation": { zh: "前台导航菜单", en: "Storefront Navigation" },
  "settings.navigationDesc": { zh: "编辑 Logo 下方显示的主菜单。下拉菜单会先作为占位保留，等二级页面确定后再填充。", en: "Edit the main menu shown under the logo. Dropdowns are placeholders until submenu pages are finalized." },
  "settings.navigationSaved": { zh: "导航菜单已保存。", en: "Navigation menu saved." },
  "settings.navigationAdd": { zh: "添加菜单", en: "Add" },
  "settings.navigationReset": { zh: "重置", en: "Reset" },
  "settings.navigationSave": { zh: "保存导航", en: "Save navigation" },
  "settings.navigationOrder": { zh: "排序", en: "Order" },
  "settings.navigationLabel": { zh: "菜单名称", en: "Label" },
  "settings.navigationLink": { zh: "链接", en: "Link" },
  "settings.navigationDropdown": { zh: "下拉菜单", en: "Dropdown" },
  "settings.navigationParent": { zh: "父级菜单", en: "Parent" },
  "settings.navigationTopLevel": { zh: "顶级菜单", en: "Top level" },
  "settings.navigationVisible": { zh: "显示", en: "Visible" },
  "settings.navigationActions": { zh: "操作", en: "Actions" },
  "settings.navigationUp": { zh: "上移", en: "Up" },
  "settings.navigationDown": { zh: "下移", en: "Down" },
  "settings.navigationOn": { zh: "开启", en: "On" },
  "settings.navigationOff": { zh: "关闭", en: "Off" },
  "settings.navigationShow": { zh: "显示", en: "Show" },
  "settings.navigationHide": { zh: "隐藏", en: "Hide" },
  "settings.navigationDelete": { zh: "删除", en: "Delete" },
  "settings.navigationNewItem": { zh: "新菜单项", en: "New Menu Item" },
